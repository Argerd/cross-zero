            ...
            switch (turnCounter) {
                ...
                case 2:
                    ...
                    if (fieldMap[4].equals("X") && fieldMap[3].equals("X") && fieldMap[7].equals("X")
                        ...
                        System.out.println("fmbklnblkrb");
                        if (fieldMap[2].equals("X")) {
                            return 6;
                        } else {
                            return 2;
